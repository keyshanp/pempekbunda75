  ...
  <main class="flex-grow" style="padding: 40px 16px; max-width: 1200px; margin-left: auto; margin-right: auto; width: 100%;">
    ...
    <div class="animate-fade-in">
      <div class="flex flex-col sm:flex-row justify-between items-start sm:items-baseline mb-8 sm:mb-12 gap-3">
        ...
        <a href="{{ route('order.index') }}" class="text-[#C6584F] font-reenie text-2xl sm:text-3xl flex items-center gap-2 hover:underline whitespace-nowrap">
          ← Lanjut Belanja
        </a>
      </div>
          ...
          <div class="lg:col-span-2 space-y-4">
            <template x-for="(item, index) in cart" :key="item.id">
              <div class="bg-white rounded-2xl p-4 flex items-center gap-6 border border-[#E8DCC4] shadow-sm">
                <img x-bind:src="item.image" x-bind:alt="item.name" onerror="this.src='{{ asset('assets/images/pempekbunda5.png') }}'" class="w-24 h-24 rounded-xl object-cover">
                <div class="flex-grow">
