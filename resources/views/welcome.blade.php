...
<header class="header">
  <div class="logo-container">
    <a href="#home" class="logo-link">
      <img src="{{ asset('assets/images/logobrand.png') }}" alt="Pempek Bunda 75 Logo" class="brand-logo hover-rotate">
    </a>
  </div>
...
<main class="main-content">
  ...
  <section class="hero" id="home">
    ...
    <div class="hero-right animate-slide-right">
      <img src="{{ asset('assets/images/Pempek.png') }}" alt="Pempek" class="hero-img animate-float">
    </div>
  </section>
      ...
      <div class="product-scroll-wrapper no-scrollbar">
        ...
        <a href="{{ route('order.index') }}" class="group product-card animate-slide-up" style="animation-delay: {{ 0.1 * $index }}s;">
          <div>
            ...
            @else
              <img src="{{ asset('assets/images/Pempek.png') }}" alt="{{ $product->nama_produk }}">
            @endif
          </div>
          <div>
...
<footer class="footer">
  ...
  <div class="footer-right">
    <a href="#home" class="footer-logo-link">
      <img src="{{ asset('assets/images/logobrand.png') }}" alt="Pempek Bunda 75 Logo" class="footer-logo animate-pulse-custom hover-scale">
    </a>
  </div>
</footer>
