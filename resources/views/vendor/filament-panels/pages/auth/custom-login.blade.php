...
<head>
    ...
    <title>Masuk - Pempek Bunda 75</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Finger+Paint&family=Patrick+Hand&display=swap" rel="stylesheet">
    <style>
        ...
        /* Paper texture tanpa external image */
        .paper-texture {
            background: 
        ...
        .paper-texture::before {
            ...
            background: 
                ...
                radial-gradient(circle at 40% 20%, rgba(0,0,0,0.1) 1%, transparent 1%),
                radial-gradient(circle at 80% 60%, rgba(255,255,255,0.05) 3%, transparent 3%);
            pointer-events: none;
        }
        ...
        <div class="w-full md:w-[45%] p-8 md:p-12 flex flex-col justify-center bg-white">
            <div class="max-w-xs mx-auto w-full">
                ...
                <div class="flex justify-center md:justify-start gap-6 mb-8">
                    <button type="button" class="w-12 h-12 rounded-full bg-white border-2 border-gray-300 flex items-center justify-center hover:border-[#c48474] transition-colors">
                ...
                <form method="POST" action="{{ route('filament.admin.auth.login') }}" class="space-y-4">
                    ...
                    <div class="flex items-center justify-between mt-4">
                        ...
                        @if(config('filament.auth.password_reset.enabled'))
                        <a href="{{ route('filament.admin.password-reset.request') }}" class="font-hand text-[#7c2d12] text-lg hover:underline">
                            Lupa password?
                        </a>
                        @endif
                    </div>
                    ...
                    <div class="flex gap-4 pt-6">
                        ...
                        @if(config('filament.auth.registration.enabled'))
                        <a
