...
>
    <a
        ...
        class="<?php echo \Illuminate\Support\Arr::toCssClasses([
            'fi-sidebar-item-button relative flex items-center justify-center gap-x-3 rounded-lg px-2 py-2 outline-none transition duration-75 hover:bg-gray-100 focus-visible:bg-gray-100',
            'bg-gray-100' => $active,
        ]); ?>"
    >
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(filled($icon) && ((! $subGrouped) || filament()->isSidebarCollapsibleOnDesktop())): ?>
...
<?php /**PATH C:\Users\keand\OneDrive\Desktop\Sekolah\Kelas 12\pempekbunda75\resources\views/vendor/filament-panels/components/sidebar/item.blade.php ENDPATH**/ ?>