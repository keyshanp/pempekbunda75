...
<body class="min-h-screen flex flex-col">
    ...
    <div data-user-name="<?php echo e(auth()->check() ? auth()->user()->name : 'Guest'); ?>" 
         data-user-email="<?php echo e(auth()->check() ? auth()->user()->email : ''); ?>"
    ...
    <main class="flex-grow" style="margin-top: 120px; padding: 40px 20px; max-width: 1400px; margin-left: auto; margin-right: auto; width: 100%;">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($order) && $order): ?>
                    ...
                    <div class="bg-white p-8 rounded-[2rem] border-2 border-[#758E27] shadow-lg">
                        ...
                        <div class="relative mb-8 px-4">
                            ...
                            <div class="absolute top-5 left-0 h-1 bg-[#758E27] rounded-full transition-all duration-500" 
                                 style="width: <?php echo e(($currentStage / 4) * 100); ?>%;"></div>

                            <!-- Stages -->
                            <div class="relative flex justify-between">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $stages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $stage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                        $isActive = $index <= $currentStage;
                                        $isCurrent = $index === $currentStage;
                                    ?>
                                    <div class="flex flex-col items-center">
                                        <div class="w-10 h-10 rounded-full flex items-center justify-center font-bold text-sm transition-all duration-300 <?php echo e($isActive ? 'bg-[#758E27] text-white shadow-lg scale-110' : 'bg-gray-200 text-gray-400'); ?> <?php echo e($isCurrent ? 'ring-4 ring-[#758E27]/20' : ''); ?>">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isActive && $index < $currentStage): ?>
                                        ...
                                        <span class="mt-2 text-sm font-bold tracking-wider <?php echo e($isActive ? 'text-[#758E27]' : 'text-gray-400'); ?>" style="font-family: 'Bubblegum Sans', cursive;">
                                            <?php echo e($stage); ?>
                        ...
                        <div class="bg-[#FFF8EE] p-6 rounded-2xl border-2 border-[#E8DCC4]">
                            ...
                            <div class="countdown text-4xl font-bold text-[#C6584F] text-center mb-2" 
                                 data-deadline="<?php echo e($batasPembayaran->format('Y-m-d H:i:s')); ?>">
                                <?php echo e($batasPembayaran->diffForHumans(['parts' => 2])); ?>

                            </div>
                            
                            <p class="text-sm text-gray-500 text-center italic" style="font-family: 'Bubblegum Sans', cursive;">
                                Segera lakukan pembayaran sebelum <?php echo e($batasPembayaran->format('H:i')); ?> WIB
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-[2rem] border-2 border-[#758E27] shadow-lg">
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-6 p-4 bg-[#FFF8EE] rounded-xl" style="font-family: 'Bubblegum Sans', cursive;">
                            <div>
                                ...
                                <p class="font-mono font-bold text-[#5C3D2E]"><?php echo e($kodePesanan); ?></p>
                            </div>
                            <div>
                                <p class="text-xs text-gray-500 uppercase">Tanggal</p>
                                <p class="font-bold text-[#5C3D2E]"><?php echo e($tanggalPesanan->format('d M Y H:i')); ?></p>
                            </div>
                            <div>
                                <p class="text-xs text-gray-500 uppercase">Status</p>
                                <span class="status-badge <?php echo e($statusClass); ?>">
                                    <?php echo e(strtoupper(str_replace('_', ' ', $statusPesanan))); ?>

                                </span>
                            </div>
                            <div>
                                <p class="text-xs text-gray-500 uppercase">Metode Bayar</p>
                                <p class="font-bold text-[#5C3D2E]">QRIS (<?php echo e($ewallet); ?>)</p>
                            </div>
                        </div>
                        ...
                        <div class="mb-6 p-4 bg-[#FFF8EE] rounded-xl" style="font-family: 'Bubblegum Sans', cursive;">
                            ...
                            <div class="grid grid-cols-2 gap-3 text-sm">
                                <div>
                                    ...
                                    <p class="font-bold"><?php echo e($customer['nama'] ?? '-'); ?></p>
                                </div>
                                <div>
                                    <p class="text-gray-500 text-xs">Email</p>
                                    <p class="font-bold"><?php echo e($customer['email'] ?? '-'); ?></p>
                                </div>
                                <div>
                                    <p class="text-gray-500 text-xs">WhatsApp</p>
                                    <p class="font-bold"><?php echo e($customer['telepon'] ?? '-'); ?></p>
                                </div>
                                <div>
                                    <p class="text-gray-500 text-xs">Pengiriman</p>
                                    <p class="font-bold"><?php echo e(($delivery['metode'] ?? '') == 'pickup' ? 'Ambil Sendiri' : 'GoSend'); ?></p>
                                </div>
                                <div class="col-span-2">
                                    <p class="text-gray-500 text-xs">Alamat</p>
                                    <p class="font-bold"><?php echo e($customer['alamat'] ?? '-'); ?></p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="flex justify-between items-center p-3 bg-[#FFF8EE] rounded-xl" style="font-family: 'Bubblegum Sans', cursive;">
                                    <div class="flex items-center gap-3">
                                        <div class="w-12 h-12 bg-gray-200 rounded-lg overflow-hidden flex-shrink-0">
                                            <img src="<?php echo e($item['image'] ?? asset('assets/images/Pempek.png')); ?>" 
                                                 alt="<?php echo e($item['name']); ?>"
                                                 class="w-full h-full object-cover">
                                        </div>
                                        <div>
                                            <p class="font-bold text-[#5C3D2E]"><?php echo e($item['name']); ?></p>
                        ...
                        <div class="border-t border-[#E8DCC4] pt-4" style="font-family: 'Bubblegum Sans', cursive;">
                            <div class="space-y-2">
                                <div class="flex justify-between text-sm">
                                    ...
                                    <span class="font-bold text-[#5C3D2E]">Rp <?php echo e(number_format($subtotal, 0, ',', '.')); ?></span>
                                </div>
                                <div class="flex justify-between text-sm">
                                    <span class="text-gray-500">Ongkos Kirim</span>
                                    <span class="font-bold text-[#5C3D2E]">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($delivery['shipping_cost'] == 0): ?>
                                            GRATIS
                                        <?php else: ?>
                                            Rp <?php echo e(number_format($delivery['shipping_cost'], 0, ',', '.')); ?>
                                ...
                                <div class="flex justify-between text-lg font-bold pt-2 border-t border-[#E8DCC4]">
                                    ...
                                    <span class="text-[#C6584F]">Rp <?php echo e(number_format($total, 0, ',', '.')); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="feedback-section w-full mt-12" 
                 x-data="feedbackSystem('<?php echo e($kodePesanan); ?>', {
                    userName: '<?php echo e(auth()->check() ? auth()->user()->name : 'Guest'); ?>',
                    userEmail: '<?php echo e(auth()->check() ? auth()->user()->email : ''); ?>'
                 })" 
                 x-init="init()"
                 x-cloak>
        ...
        <?php else: ?>
            ...
            <div class="max-w-3xl mx-auto bg-white p-8 rounded-[2rem] border border-[#E8DCC4] shadow-sm text-center">
                ...
                <p class="text-gray-500 mb-8" style="font-family: 'Bubblegum Sans', cursive;">ID Pesanan: <?php echo e(request()->route('invoice')); ?></p>
                <a href="<?php echo e(route('home')); ?>" class="inline-block bg-[#C6584F] text-white px-8 py-3 rounded-full font-bold hover:bg-[#b04d45] transition-all" style="font-family: 'Bubblegum Sans', cursive;">
                    Kembali ke Beranda
                </a>
            </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <footer class="footer">
        <div class="footer-left">
            ...
            <a href="<?php echo e(route('order.my-orders')); ?>" class="footer-link">cek pesanan</a>
        </div>
    ...
    <script>
        ...
        const orderStatus = '<?php echo e($statusPesanan ?? "pending"); ?>';
        const orderStatusPayment = '<?php echo e($statusPembayaran ?? "belum_bayar"); ?>';
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const orderCode = '<?php echo e($kodePesanan ?? ''); ?>';
            if (orderCode) {
...
</html><?php /**PATH C:\Users\keand\OneDrive\Desktop\Sekolah\Kelas 12\pempekbunda75\resources\views/order/invoice.blade.php ENDPATH**/ ?>