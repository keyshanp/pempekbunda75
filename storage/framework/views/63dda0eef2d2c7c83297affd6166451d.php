  ...
  <div class="main-wrapper">
    <div class="center-container">
      <main class="animate-fade-in">
        ...
        <a href="<?php echo e(route('order.index')); ?>" class="back-to-cart">
                ...
                <section class="bg-white p-6 rounded-2xl border border-[#E8DCC4] shadow-sm space-y-4">
                  ...
                  <div>
                    ...
                    <input 
                      ...
                      value="<?php echo e(auth()->user()->name ?? 'Customer Bunda'); ?>"
                      readonly
                  ...
                  <div>
                    ...
                    <input 
                      ...
                      value="<?php echo e(auth()->user()->email ?? 'customer@gmail.com'); ?>"
                      readonly
                      class="w-full bg-[#FFF8EE] border border-[#E8DCC4] rounded-lg p-2 text-[#5C3D2E] focus:outline-none"
                    >
                  </div>
                ...
                <section class="bg-white p-6 rounded-2xl border border-[#E8DCC4] shadow-sm">
                  ...
                  <div class="bg-[#FFF8EE] p-4 rounded-xl flex flex-col items-center border border-[#E8DCC4]">
                    ...
                    <div class="w-48 h-48 bg-white p-2 rounded-lg shadow-inner mb-4 flex items-center justify-center">
                      <img src="<?php echo e(asset('assets/images/Payment1.jpeg')); ?>" alt="QRIS Payment" class="w-full h-full object-contain">
                    </div>
  ...
  <script>
    function paymentPage() {
      return {
        ...
        formData: {
          name: '<?php echo e(auth()->user()->name ?? "Customer Bunda"); ?>',
          email: '<?php echo e(auth()->user()->email ?? "customer@gmail.com"); ?>',
          whatsapp: '',
          address: '',
          addressNotes: '',
          lat: null,
        ...
        loadData() {
          ...
          <?php if(auth()->guard()->check()): ?>
            this.formData.name = '<?php echo e(auth()->user()->name); ?>';
            this.formData.email = '<?php echo e(auth()->user()->email); ?>';
          <?php endif; ?>
        ...
        // SYNC CART KE SESSION SERVER
        syncCartToSession() {
          fetch('<?php echo e(route('order.sync-cart')); ?>', {
            method: 'POST',
            headers: {
        ...
        submitForm() {
          ...
          fetch('<?php echo e(route('order.payment.process')); ?>', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
              'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content
          ...
          .then(data => {
            ...
            if (data.success) {
              ...
              fetch('<?php echo e(route('order.order.process')); ?>', {
                method: 'POST',
                headers: {
                  'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content
                },
...
</html><?php /**PATH C:\Users\keand\OneDrive\Desktop\Sekolah\Kelas 12\pempekbunda75\resources\views/order/payment.blade.php ENDPATH**/ ?>