    ...
    <div class="fi-layout flex min-h-screen w-full overflow-x-clip">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(filament()->hasNavigation()): ?>
            <div
                ...
                class="fi-sidebar-close-overlay fixed inset-0 z-30 bg-gray-950/50 transition duration-500 lg:hidden"
            ></div>
...
<?php endif; ?>
<?php /**PATH C:\Users\keand\OneDrive\Desktop\Sekolah\Kelas 12\pempekbunda75\resources\views/vendor/filament-panels/components/layout/index.blade.php ENDPATH**/ ?>