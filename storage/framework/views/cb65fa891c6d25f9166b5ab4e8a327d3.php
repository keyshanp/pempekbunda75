...
<head>
    ...
    <title>Buat Akun - Pempek Bunda 75</title>
    ...
    <div class="w-full max-w-5xl h-full md:h-[750px] bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row border-4 border-white">
        ...
        <div class="w-full md:w-[45%] p-8 md:p-12 flex flex-col justify-center bg-white">
            <div class="max-w-xs mx-auto w-full">
                ...
                <h1 class="text-5xl md:text-6xl font-rascal text-[#7c2d12] mb-8 tracking-tighter text-center md:text-left leading-none">
                    Buat Akun
                </h1>
                    ...
                    <div class="flex items-start gap-3 mt-4">
                        <div class="relative flex items-center h-5">
                            <input
                                ...
                                name="consent"
                                type="checkbox"
                                class="w-5 h-5 border-2 border-[#7c2d12] rounded bg-transparent focus:ring-0 accent-[#c48474]"
                                required
                            >
                        </div>
                        <label for="consent" class="font-hand text-[#7c2d12] text-xl leading-none">
...
</html><?php /**PATH C:\laragon\www\2maretpempekbundacode\pempekbunda75\resources\views/auth/register.blade.php ENDPATH**/ ?>