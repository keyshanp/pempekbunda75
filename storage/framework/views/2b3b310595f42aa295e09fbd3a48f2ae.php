...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin - PempekBunda 75'); ?></title>
...
<body>
    ...
    <div class="react-sidebar">
        ...
        <nav class="sidebar-nav">
            <?php
                ...
                if (str_contains($currentPath, 'produks')) {
                    ...
                    $active = 'transactions';
                } elseif (str_contains($currentPath, 'feedback')) {
                    $active = 'feedback';
                }
            ?>

            <!-- Dashboard -->
            <a href="<?php echo e(url('/admin')); ?>" class="sidebar-item <?php echo e($active === 'dashboard' ? 'sidebar-item-active' : ''); ?>">
                <svg class="sidebar-icon <?php echo e($active === 'dashboard' ? 'text-white' : 'text-[#BC5A42]'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Produk -->
            <a href="<?php echo e(url('/admin/produks')); ?>" class="sidebar-item <?php echo e($active === 'products' ? 'sidebar-item-active' : ''); ?>">
                <svg class="sidebar-icon <?php echo e($active === 'products' ? 'text-white' : 'text-[#BC5A42]'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Pesanan -->
            <a href="<?php echo e(url('/admin/orders')); ?>" class="sidebar-item <?php echo e($active === 'orders' ? 'sidebar-item-active' : ''); ?>">
                <svg class="sidebar-icon <?php echo e($active === 'orders' ? 'text-white' : 'text-[#BC5A42]'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"></path>
                </svg>
                <span>Pesanan</span>
            </a>
            ...
            <!-- Transaksi -->
            <a href="<?php echo e(url('/admin/transaksis')); ?>" class="sidebar-item <?php echo e($active === 'transactions' ? 'sidebar-item-active' : ''); ?>">
                <svg class="sidebar-icon <?php echo e($active === 'transactions' ? 'text-white' : 'text-[#BC5A42]'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Feedback -->
            <a href="<?php echo e(url('/admin/feedback')); ?>" class="sidebar-item <?php echo e($active === 'feedback' ? 'sidebar-item-active' : ''); ?>">
                <svg class="sidebar-icon <?php echo e($active === 'feedback' ? 'text-white' : 'text-[#BC5A42]'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="sidebar-footer">
            <form method="POST" action="<?php echo e(route('filament.admin.auth.logout')); ?>" class="w-full">
                <?php echo csrf_field(); ?>
    ...
    <div class="custom-topbar">
        ...
        <div class="topbar-user">
            <div class="text-right">
                <p class="user-name"><?php echo e(Auth::user()->name ?? 'Bunda Admin'); ?></p>
                <p class="user-role">Pemilik Toko</p>
            </div>
            <div class="user-avatar">
                <img src="https://picsum.photos/seed/<?php echo e(Auth::user()->id ?? 'bunda'); ?>/100/100" alt="Admin">
            </div>
        </div>
    </div>
...
<?php /**PATH C:\laragon\www\2maretpempekbundacode\pempekbunda75\resources\views/layouts/filament-admin.blade.php ENDPATH**/ ?>