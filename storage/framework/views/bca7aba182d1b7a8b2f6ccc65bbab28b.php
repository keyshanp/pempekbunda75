...
<?php endif; ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($subheading): ?>
            <p
                class="fi-header-subheading mt-2 max-w-2xl text-lg text-gray-600"
            >
...
<?php /**PATH C:\Users\keand\OneDrive\Desktop\Sekolah\Kelas 12\pempekbunda75\resources\views/vendor/filament-panels/components/header/index.blade.php ENDPATH**/ ?>